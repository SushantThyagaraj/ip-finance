...
class CardPage extends Component {
    render() {
        ...
        <Container>
            <Row>
                <Col> <Cards title="Enterprise #1" subtitle="Invest in us!" text="The power to change lives." 
                ...
                <Col> <Cards title="Enterprise #2" subtitle="Invest in us!" text="The power to change lives." 
                        imgsrc="https://mountainx.com/wp-content/uploads/2017/12/DonationButton-330x330.png"/> </Col>
                <Col> <Cards title="Enterprise #3" subtitle="Invest in us!" text="The power to change lives." 
